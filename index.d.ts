...
declare module "ln-service" {
	 ...
	 */
	export async function addPeer(variables: {
	 ...
	 */
	export async function broadcastChainTransaction(variables: {
	 ...
	 */
	export async function calculateHops(variables: {
		channels: Channel[]
	 ...
	 */
	export async function calculatePaths(variables: {
		channels: Channel[]
		/** End Public Key Hex String */
		end: string
	 ...
	 * TODO: return type?
	 */
	export async function cancelHodlInvoice(variables: {
	 ...
	 * TODO: return type?
	 */
	export async function cancelPendingChannel(variables: {
	 ...
	 */
	export async function closeChannel(variables: {
		address?: string
		id?: string
	 ...
	 * TODO: Return type?
	 */
	export async function connectWatchtower(variables: {
		/** Authenticated LND API Object */
		lnd: LND
	 ...
	 * TODO: Return type?
	 */
	export async function createChainAddress(variables: {
	 ...
	 */
	export async function createHodlInvoice(variables: {
